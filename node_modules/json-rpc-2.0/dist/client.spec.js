...
mocha_1.describe("JSONRPCClient", function () {
    ...
    mocha_1.beforeEach(function () {
        ...
        resolve = undefined;
        reject = undefined;
        client = new _1.JSONRPCClient(function (request) { return function (clientParams) {
            lastRequest = request;
    ...
    mocha_1.describe("requesting", function () {
        ...
        mocha_1.beforeEach(function () {
            ...
            promise = client
                .request("foo", ["bar"])
                .then(function (givenResult) { return (result = givenResult); }, function (givenError) { return (error = givenError); });
        });
